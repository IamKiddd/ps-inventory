          ...
          $.each(data.AttachmentData, function (i, attachment) {
            ...
            $(".weapon-attachments").append(
              '<div class="weapon-attachment" id="weapon-attachment-' +
                ...
                attachment.label +
                '</p></div> <div class="weapon-attachment-img"><img src="' + getImgSrc(attachment.info) +
                attachment.image +
                '"></div> </div>'
            );
            attachment.id = i;
  ...
  if (itemData != null && itemData.info != "") {
      if (itemData.name == "id_card") {
          ...
          $(".item-info-description").html(
              ...
              "</span></p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.quality) + "</a>"
          ...
          if (itemData.info.type == "casing") {
              ...
              $(".item-info-description").html(
                  ...
                  "</span></p><br /><p>" +
                  itemData.description +
                  "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.quality) + "</a>"
              );
          ...
          $(".item-info-title").html("<p>" + itemData.label + "</p>");
          $(".item-info-description").html("<p>" + itemData.info.costs + "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.quality) + "</a>");
      } else if (itemData.name == "stickynote") {
          $(".item-info-title").html("<p>" + itemData.label + "</p>");
          $(".item-info-description").html("<p>" + itemData.info.label + "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.quality) + "</a>");
          ...
          var cardNumber = "************" + res;
          $(".item-info-description").html('<p><strong>Card Holder: </strong><span>' + itemData.info.name + '</span></p><p><strong>Citizen ID: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Card Number: </strong><span>' + cardNumber + '</span></p><p style=\"font-size:11px\"><b>Weight: </b>' + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.quality) + "</a>");
      } else if (itemData.name == "labkey") {
          $(".item-info-title").html("<p>" + itemData.label + "</p>");
          $(".item-info-description").html("<p>Lab: " + itemData.info.lab + "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.quality) + "</a>");
      } else {
          $(".item-info-title").html("<p>" + itemData.label + "</p>");
          $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.quality) + "</a>");
      }
  } else {
      $(".item-info-title").html("<p>" + itemData.label + "</p>");
      $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.quality) + "</a>");
...
function handleDragDrop() {
  ...
  $(".item-slot").droppable({
    ...
    drop: function (event, ui) {
      ...
      if (toAmount >= 0) {
        if (toAmount <= fromDataUnique.amount) {
          if (!toDataUnique) {
            if (
  ...
  if (
      ...
      if ($fromInv.attr("data-inventory").split("-")[0] == "itemshop") {
          $fromInv
              .find("[data-slot=" + $fromSlot + "]")
              .html(
                  '<div class="item-slot-img"><img src="' + getImgSrc(itemData.info) +
                  itemData.image +
                  '" alt="' +
                  itemData.name +
...
function optionSwitch(
  ...
  if ($toSlot < 6) {
    $toInv
      ...
      .html(
        '<div class="item-slot-key"><p>' +
          $toSlot +
          '</p></div><div class="item-slot-img"><img src="' + getImgSrc(fromData.info) +
          fromData.image +
          '" alt="' +
          fromData.name +
          '" /></div><div class="item-slot-amount"><p>' +
    ...
    $toInv
      .find("[data-slot=" + $toSlot + "]")
      .html(
        '<div class="item-slot-img"><img src="' + getImgSrc(fromData.info) +
          fromData.image +
          '" alt="' +
          fromData.name +
          '" /></div><div class="item-slot-amount"><p>' +
  ...
  if ($fromSlot < 6) {
    $fromInv
      ...
      .html(
        '<div class="item-slot-key"><p>' +
          $fromSlot +
          '</p></div><div class="item-slot-img"><img src="' + getImgSrc(toData.info) +
          toData.image +
          '" alt="' +
          toData.name +
          '" /></div><div class="item-slot-amount"><p>' +
      ...
      $.post(
        ...
        JSON.stringify({
          ...
          fromAmount: $toAmount,
            ...
            Inventory.UpdateInv(data)
            Inventory.UpdateOther(data)
        }
      );
    } else {
...
function InventoryError($elinv, $elslot) {
  ...
  data.maxweight = playerMaxWeight
  Inventory.UpdateInv(data)
  Inventory.UpdateOther(data)
...
(() => {
  ...
  Inventory.UpdateInv = function (data) {
          ...
          if (item.slot < 6) {
            ...
            $(".player-inventory")
              ...
              .html(
                '<div class="item-slot-key"><p>' +
                  item.slot +
                  '</p></div><div class="item-slot-img"><img src="' +  getImgSrc(item.info) +
                  item.image +
                  '" alt="' +
                  item.name +
                  '" /></div><div class="item-slot-amount"><p>' +
            ...
            $(".player-inventory")
              .find("[data-slot=" + item.slot + "]")
              .html(
                '<div class="item-slot-key"><p>6 <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="' + getImgSrc(item.info) +
                  item.image +
                  '" alt="' +
                  item.name +
                  '" /></div><div class="item-slot-amount"><p>' +
    ...
    playerSlots = data.slots
    handleDragDrop();
  };
  Inventory.UpdateOther = function (data) {
    if (data.inventory === false) {
      handleDragDrop();
      return
    }
        ...
        if (item != null) {
          ...
          if (item.slot == 43) {
            $(".z-hotbar-inventory")
              .find("[data-zhotbarslot=" + item.slot + "]")
              .html(
                '<div class="z-hotbar-item-slot-key"><p>6 <i style="top: -62px; left: 58px;" class="fas fa-lock"></i></p></div><div class="z-hotbar-item-slot-img"><img src="' +  getImgSrc(item.info) +
                  item.image +
                  '" alt="' +
                  item.name +
            ...
            $(".z-hotbar-inventory")
              ...
              .html(
                '<div class="z-hotbar-item-slot-key"><p>' +
                  item.slot +
                  '</p></div><div class="z-hotbar-item-slot-img"><img src="' +  getImgSrc(item.info) +
                  item.image +
                  '" alt="' +
                  item.name +
                  '" /></div><div class="z-hotbar-item-slot-amount"><p>' +
  ...
  Inventory.UseItem = function (data) {
    ...
    $("#itembox-image").html(
      '</p></div><div class="item-slot-img"><img src="' + getImgSrc(data.item.info) +
        data.item.image +
        '" alt="' +
        data.item.name +
        '" /></div>'
  ...
  Inventory.itemBox = function (data) {
    ...
    $itembox.html(
      '<div id="itembox-action"><p>' +
        ...
        data.item.label +
        '</p></div><div class="item-slot-img-itembox"><img src="' +  getImgSrc(data.item.info) +
        data.item.image +
        '" alt="' +
        data.item.name +
        '" /></div>'
      ...
      if (!requiredItemOpen) {
        ...
        $.each(data.items, function (index, item) {
          var element =
            ...
            item.label +
            '</p></div><div id="requiredItem-image"><div class="item-slot-img"><img src="' +  getImgSrc(item.info) +
            item.image +
            '" alt="' +
            item.name +
            '" /></div></div></div>';
